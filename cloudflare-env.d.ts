/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 49611f05ad87da1d1b8c76d8abfedfdd)
// Runtime types generated with workerd@1.20251210.0 2025-10-25 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "PAYLOAD_SECRET" | "S3_BUCKET" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "S3_REGION" | "S3_ENDPOINT" | "PREVIEW_SECRET" | "CRON_SECRET" | "NEXT_PUBLIC_SERVER_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE">> {}
}
