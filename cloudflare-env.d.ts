/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: e0e6720f38498602a3d7abd4e6a152a9)
// Runtime types generated with workerd@1.20260217.0 2025-10-25 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		ASSETS: Fetcher;
		NEXT_PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAACeUkqYATOyVaWw6";
		HUBSPOT_BLOG_LIST_ID: "9";
		CRON_SECRET: string;
		...
		WORKER_SELF_REFERENCE: Fetcher /* synteq-enterprise */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "HUBSPOT_BLOG_LIST_ID" | "CRON_SECRET">> {}
}
