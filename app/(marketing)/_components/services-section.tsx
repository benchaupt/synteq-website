      ...
      <div className="flex flex-col gap-8 md:gap-12 lg:gap-16 w-full">
        ...
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-52 items-start lg:items-end w-full">
          <div className="flex flex-col gap-3 flex-1">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight tracking-tight text-foreground font-sequel-book">
              Purpose-built<br />
              for AI at scale
            </h2>
          </div>
          <p className="text-base md:text-lg lg:text-xl text-dark-foreground flex-1 leading-relaxed max-w-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
          ...
          <Link 
            ...
            className="group bg-background-secondary border border-white/10 hover:border-accent/50 flex flex-col justify-between overflow-hidden relative transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl hover:shadow-accent/10 cursor-pointer min-h-[400px] md:min-h-[500px] lg:min-h-[580px]"
          >
            <div className="px-6 md:px-8 lg:px-9 pt-6 md:pt-8 lg:pt-9 pb-4 md:pb-5 lg:pb-6 z-10 flex flex-col gap-3 md:gap-4">
              <h3 className="text-2xl md:text-3xl lg:text-4xl tracking-tight text-white group-hover:text-accent transition-colors duration-300">
                {products[0].title}
              </h3>
              <p className="text-base md:text-lg text-dark-foreground group-hover:text-foreground/80 leading-relaxed transition-colors duration-300">
            ...
            <div className="w-full flex items-end justify-center opacity-70 group-hover:opacity-100 transition-opacity duration-300 overflow-hidden">
          ...
          >
            ...
            <div className="w-full flex items-end justify-start opacity-70 group-hover:opacity-100 transition-opacity duration-300 overflow-hidden">
              <div className="w-full min-h-[250px] md:min-h-[300px] lg:min-h-[350px] relative">
