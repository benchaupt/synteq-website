            ...
            <div className="bg-dark px-5">
                ...
                <div className="py-32 flex flex-col gap-12">
                    <div className="relative flex flex-col gap-8">
                        ...
                        <div className="absolute top-0 right-0 w-[200px] h-full bg-linear-to-l from-background to-transparent" style={{
                            zIndex: 999,
                        }} />
                        <div
                                ...
                                <div className='embla__container'>
                                    {hardware.map((hardware, index) => (
                                        <div key={index} onClick={() => {
                                            ...
                                            <AnimatedCard className="min-w-[300px] m-5 mx-8" disableScale disableTextColor isActive={index === currentIndex}>
                                                <div className="flex flex-col gap-10 items-center justify-center">
                                                    <img src={hardware.image} className="object-contain" />
                                                    <h3 className={cn("text-xl transition-all duration-400", index === currentIndex ? "text-accent" : "text-white")}>{hardware.name}</h3>
                                                </div>
                                            </AnimatedCard>
                                        </div>
                                    ))}
            ...
            <div className="bg-dark max-w-[1800px] w-full mx-auto px-5">
                <div className="py-32 flex flex-col gap-12">
                    ...
                    <div className="grid grid-cols-5 gap-8 w-full">
                        <div className="col-span-3 flex flex-col justify-start gap-12">
                            <div className="flex items-center justify-start">
                                <div className="grid grid-cols-4 gap-12">
                                    <div className="flex flex-col text-2xl pr-12">
                                        <p className="text-white/50">vRAM</p>
                                        <h2 className="text-3xl inline-flex items-center gap-0.5">128<span className="text-xl">gb</span></h2>
                                    </div>
