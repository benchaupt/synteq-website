...
export default function Hardware() {
  return (
    <>
      ...
      <SelectHardware />
      {/* product compare */}
      <div className="max-w-viewport w-full mx-auto px-5 flex flex-col gap-10 pb-16">
        ...
        <div className="grid grid-cols-3 md:grid-cols-4 gap-4 md:gap-16 p-0 md:p-12">
          ...
          <AnimatedCard className="lg:min-w-[300px] md:p-8 md:px-12 p-2 sm:p-4 sm:px-6" disableScale disableTextColor>
          ...
          <AnimatedCard className="hidden md:block lg:min-w-[300px] md:p-8 md:px-12 p-2 sm:p-4 sm:px-6" disableScale disableTextColor>
            <div className="flex flex-col gap-2 md:gap-10 items-center justify-center">
              <img src="/assets/hardware/Group 20.png" className="object-contain" />
              <h3 className="text-xs sm:text-sm md:text-xl transition-all duration-400">Nvidia H100</h3>
            </div>
        ...
        <div className="hidden md:grid grid-cols-4 gap-16 bg-background-secondary p-12">
