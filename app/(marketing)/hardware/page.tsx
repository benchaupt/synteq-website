  ...
  return (
    <>
      ...
      {/* Section Divider */}
        ...
        <SelectHardware className="py-0 md:py-0" />
      ...
      <div className="max-w-viewport w-full mx-auto px-5 py-16 md:py-24">
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <CornerCard className="flex flex-col gap-6 p-8">
              <div className="flex flex-col gap-4 items-center">
                <div className="size-24 flex items-center justify-center">
                  <img src="/assets/hardware/Group 20.png" className="object-contain" alt="Nvidia H100" />
          </div>
                <h3 className="font-mono text-sm md:text-sm lg:text-sm font-medium">Nvidia H100</h3>
            ...
            <CornerCard className="flex flex-col gap-6 p-8">
              <div className="flex flex-col gap-4 items-center">
                ...
                <h3 className="font-mono text-sm md:text-sm lg:text-sm font-medium">Nvidia H200</h3>
            ...
            <CornerCard className="flex flex-col gap-6 p-8">
              <div className="flex flex-col gap-4 items-center">
                ...
                <h3 className="font-mono text-sm md:text-sm lg:text-sm font-medium">Nvidia A100</h3>
