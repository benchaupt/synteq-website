                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    ...
                    >
                        <div className="size-24 mx-auto">
                            <svg width="128" height="128" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                                <g clipPath="url(#clip0_608_2687)">
                                ...
                                <defs>
                                    <filter id="filter0_f_608_2687" x="-0.00130272" y="0.00162697" width="127.999" height="127.999" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                                    ...
                                    <linearGradient id="paint0_linear_608_2687" x1="63.999" y1="21.3332" x2="63.999" y2="106.667" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="currentColor" className="text-[#575757] group-hover:text-[#F5EAEA] transition-colors duration-500" />
                                        <stop offset="1" stopColor="currentColor" className="text-[#151515] group-hover:text-[#FCFCFC] transition-colors duration-500" />
                                    </linearGradient>
                                    ...
                                    <linearGradient id="paint2_linear_608_2687" x1="63.9987" y1="5.3335" x2="63.9987" y2="122.667" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="currentColor" stopOpacity="0.6" className="text-[#E3E3E5] group-hover:text-[#31ECCC] transition-colors duration-500" />
                                        <stop offset="1" stopColor="currentColor" stopOpacity="0.6" className="text-[#BBBBC0] group-hover:text-[#31ECCC] transition-colors duration-500" />
                                    </linearGradient>
                        ...
                        <h3 className="text-xl text-white/90 group-hover:text-white transition-colors">AI applications</h3>
                        <p className="text-base text-white/60 leading-relaxed">
                    ...
                    >
                        ...
                        <h3 className="text-xl text-white/90 group-hover:text-white transition-colors">Model Experimentation</h3>
                        <p className="text-base text-white/60 leading-relaxed">
                    ...
                    >
                        ...
                        <h3 className="text-xl text-white/90 group-hover:text-white transition-colors">Scaling AI Products</h3>
                        <p className="text-base text-white/60 leading-relaxed">
                    ...
                    >
                        ...
                        <h3 className="text-xl text-white/90 group-hover:text-white transition-colors">AI Inference</h3>
                        <p className="text-base text-white/60 leading-relaxed">
