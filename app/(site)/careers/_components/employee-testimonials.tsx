...
const testimonials: EmployeeTestimonial[] = [
  {
    name: "Kara",
    since: "2023",
    avatar: "/images/team/patty.webp", // TODO: replace with kara headshot
    text: "What makes Synteq special is the people. Everyone shows up with heart and a genuine commitment to doing things right. It\u2019s rare to find a place where ambition and authenticity coexist so naturally, but that\u2019s exactly what Synteq is.",
  },
  {
    name: "Lexie",
    since: "2023",
    avatar: "/images/team/patty.webp", // TODO: replace with lexie headshot
    text: "At Synteq, people care deeply about what they do, and that makes striving for excellence feel natural. There\u2019s a shared sense of meaning in the work, and it\u2019s the kind of place where you genuinely want to do your best.",
  },
  {
    name: "Rob",
    since: "2021",
    avatar: "/images/team/rob.webp",
    text: "It\u2019s been a phenomenal experience. The team is incredibly talented and genuinely inspiring to work alongside. Everyone is passionate about what they do.",
  },
];
          ...
          <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex">
              {testimonials.map((testimonial, index) => (
                <div
                  key={index}
                  className="flex-[0_0_85%] md:flex-[0_0_auto] min-w-0 px-3 cursor-pointer"
                  onClick={() => {
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <img
                        src="/icons/quote.svg"
                        alt=""
                        className="h-3 w-auto self-start"
                      />
                      <p className="text-body-lg leading-relaxed text-lava">
                        {testimonial.text}
                      </p>
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img
                        src="/icons/quote.svg"
                        alt=""
                        className="h-3 w-auto self-end rotate-180"
                      />
                    </div>
                    {/* Author + nav */}
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          <span className="text-body-lg font-medium text-lava">
                            {testimonial.name}
                          </span>
                          <span className="text-body-sm text-lava/50">
                            With Synteq Since {testimonial.since}
                          </span>
                        </div>
                      </div>
                    </div>
