                            ...
                            <div key={index} className="min-w-1/3 px-4">
                                <div className="flex flex-col gap-4">
                                    <div className="flex flex-row gap-6 items-center">
                                        <img src={blog.image} alt={blog.title} className="h-full object-contain aspect-video w-full" />
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <h3 className="text-2xl font-medium">{blog.title}</h3>
                                        <p className="">{blog.description}</p>
                                        <p className="text-sm font-bold">{blog.date}</p>
                                    </div>
                                    {/* <Link href={blog.href} className="text-accent">Read More</Link> */}
                                </div>
                            </div>
                        ))}
                    </div>
