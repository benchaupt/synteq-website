    ...
    return (
        <div className="relative flex flex-col gap-6 md:gap-8">
            ...
            <div className="flex flex-row gap-3 md:gap-4 items-center justify-center">
                <button
                    className="size-10 flex items-center justify-center rounded-full border border-cream hover:bg-offwhite transition-colors"
                    onClick={() => {
