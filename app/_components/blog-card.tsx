  ...
  return (
    <Link href={href} className="group flex flex-col gap-4 md:gap-6">
      ...
      <div className="flex flex-col gap-2 md:gap-3">
        ...
        <p className="text-base md:text-lg text-[#ccc] leading-normal tracking-tight">
          {description}
        </p>
        <span className="font-mono text-xs md:text-sm leading-none tracking-tight text-darker-accent uppercase underline underline-offset-4 group-hover:underline-offset-6 duration-200 decoration-from-font group-hover:text-accent transition-colors">
          LEARN MORE ↘
        </span>
      </div>
    </Link>
