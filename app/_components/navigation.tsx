...
export const Navigation = () => {
    ...
    return (
        <nav className="sticky top-0 bg-background/95 backdrop-blur-sm z-50">
            <div className="flex flex-row items-center justify-between py-5 px-5 max-w-viewport w-full mx-auto">
                {/* Logo */}
                <Link href="/" className="flex items-center">
                    <svg viewBox="0 0 159 50" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 w-auto">
                ...
                <div className="hidden lg:flex flex-row items-center gap-1">
                    ...
                    >
                        ...
                        {activeDropdown === 'product' && (
                            <div className="absolute top-full left-0 pt-2 w-[600px]">
                                <div className="bg-background-secondary border border-white/10 rounded-lg shadow-2xl p-8">
                                <div className="grid grid-cols-2 gap-8">
                                    <div className="space-y-6">
                                        <h3 className="font-mono text-xs text-accent uppercase tracking-wider mb-4">Infrastructure</h3>
                                        <Link href="/hardware" className="group flex items-start gap-3 p-3 rounded-lg hover:bg-background transition-colors">
                                            ...
                                            <div>
                                                <div className="font-medium text-white group-hover:text-accent transition-colors">Hardware</div>
                                                <div className="text-xs text-white/50 mt-0.5">GPU clusters & servers</div>
                                            </div>
                                        </Link>
                                        <Link href="/cloud" className="group flex items-start gap-3 p-3 rounded-lg hover:bg-background transition-colors">
                                            <div className="size-10 rounded-lg bg-background flex items-center justify-center shrink-0">
                                                <svg className="size-5 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <div>
                                                <div className="font-medium text-white group-hover:text-accent transition-colors">Cloud Platform</div>
                                                <div className="text-xs text-white/50 mt-0.5">Deploy in minutes</div>
                                            </div>
                                        </Link>
                                    </div>
                                    <div className="space-y-6">
                                        <h3 className="font-mono text-xs text-accent uppercase tracking-wider mb-4">Platform</h3>
                                        <Link href="#" className="group flex items-start gap-3 p-3 rounded-lg hover:bg-background transition-colors">
                                            <div className="size-10 rounded-lg bg-background flex items-center justify-center shrink-0">
                                                <svg className="size-5 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <div>
                                                <div className="font-medium text-white group-hover:text-accent transition-colors">Model Library</div>
                                                <div className="text-xs text-white/50 mt-0.5">255+ production models</div>
                                            </div>
                                        </Link>
                                        <Link href="#" className="group flex items-start gap-3 p-3 rounded-lg hover:bg-background transition-colors">
                                            <div className="size-10 rounded-lg bg-background flex items-center justify-center shrink-0">
                                            ...
                                            <div>
                                                <div className="font-medium text-white group-hover:text-accent transition-colors">API</div>
                                                <div className="text-xs text-white/50 mt-0.5">OpenAPI compatible</div>
                                            </div>
                                        </Link>
                                    </div>
                                </div>
                    ...
                    >
                        ...
                        {activeDropdown === 'resources' && (
                            <div className="absolute top-full left-0 pt-2 w-[400px]">
                                <div className="bg-background-secondary border border-white/10 rounded-lg shadow-2xl p-6">
                                <div className="space-y-1">
                                    <Link href="#" className="group flex items-center gap-3 p-3 rounded-lg hover:bg-background transition-colors">
                                        ...
                                        <div className="flex-1">
                                            <div className="font-medium text-white group-hover:text-accent transition-colors text-sm">Documentation</div>
                                            <div className="text-xs text-white/50 mt-0.5">Complete guides & tutorials</div>
                                        </div>
                                    </Link>
                                    <Link href="#" className="group flex items-center gap-3 p-3 rounded-lg hover:bg-background transition-colors">
                                        <div className="text-accent">
                                        ...
                                        <div className="flex-1">
                                            <div className="font-medium text-white group-hover:text-accent transition-colors text-sm">Case Studies</div>
                                            <div className="text-xs text-white/50 mt-0.5">Customer success stories</div>
                                        </div>
                                    </Link>
                                    <Link href="#" className="group flex items-center gap-3 p-3 rounded-lg hover:bg-background transition-colors">
                                        <div className="text-accent">
                                        ...
                                        <div className="flex-1">
                                            <div className="font-medium text-white group-hover:text-accent transition-colors text-sm">Blog</div>
                                            <div className="text-xs text-white/50 mt-0.5">Latest updates & insights</div>
                                        </div>
                                    </Link>
                                </div>
                                </div>
