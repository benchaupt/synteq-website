...
export function AnimatedCard({ children, className = "", disableScale = false, disableTextColor = false, isActive = false, isOnLight = false }: AnimatedCardProps) {
  return (
    ...
    >
      ...
      <span className={cn("absolute left-0 -top-px w-3 h-[2px] rounded-l-full -translate-x-full -translate-y-1/2 group-hover:translate-x-[25%] group-hover:translate-y-[200%] group-hover:rounded-l-none group-hover:rounded-r-full transition-transform duration-200", isOnLight ? "bg-black" : "bg-white", isActive && "bg-accent translate-x-[25%] translate-y-[200%] rounded-l-none rounded-r-full")} />
      ...
      <span className={cn("absolute right-0 -top-px w-3 h-[2px] rounded-r-full translate-x-full -translate-y-1/2 group-hover:-translate-x-[25%] group-hover:translate-y-[200%] group-hover:rounded-r-none group-hover:rounded-l-full transition-transform duration-200", isOnLight ? "bg-black" : "bg-white", isActive && "bg-accent -translate-x-[25%] translate-y-[200%] rounded-r-none rounded-l-full")} />

      {/* Bottom-left corner - vertical line crossing bottom border */}
      <span className={cn("absolute -left-px bottom-0 w-[2px] h-3 rounded-b-full -translate-x-1/2 translate-y-full group-hover:-translate-y-[25%] group-hover:translate-x-[200%] group-hover:rounded-b-none group-hover:rounded-t-full transition-transform duration-200", isOnLight ? "bg-black" : "bg-white", isActive && "bg-accent -translate-y-[25%] translate-x-[200%] rounded-b-none rounded-t-full")} />
